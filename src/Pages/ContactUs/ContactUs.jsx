...
export default function ContactUs() {
  ...
  return (
    <section
      className="py-16 px-4 md:px-16 text-gray-800 mt-20"
      data-aos="fade-up"
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <p
          className="text-center text-lg mt-2 mb-12 text-gray-500"
          data-aos="fade-up"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          {/* Contact Form */}
          <div
            className="bg-secondary p-8 rounded-2xl shadow-md"
            data-aos="zoom-in"
            data-aos-delay="100"
          >
          ...
          {/* Contact Info */}
          <div className="space-y-6 text-base" data-aos="fade-left" data-aos-delay="200">
            <div className="flex items-start gap-4">
              <FaMapMarkerAlt className="text-2xl mt-1 text-primary" />
              <div>
                <h4 className="font-bold text-primary">Address</h4>
                <p className="text-gray-500">123 Green Lane, Treeville, Earth 4000</p>
              </div>
            </div>
            ...
            <div className="pt-10 border-t">
              ...
              <p className="text-gray-500">
                Whether you're interested in joining our green initiative, organizing a
                tree-planting event, or just want to say hello — our team is here to
                listen and support your journey.
              </p>
            </div>
            ...
            <div className="pt-10 border-t">
              ...
              <div className="text-gray-500 space-y-2">
                ...
                <p>
                  ...
                  Partner with us for CSR, workshops, or sustainability programs.
                </p>
              </div>
            </div>
          </div>
