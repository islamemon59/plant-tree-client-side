...
const Navbar = () => {
  ...
  const navLinks = (
    <>
      ...
      <li>
        <NavLink to="/allPlants" className="font-medium">
          All Plants
        </NavLink>
      </li>
      <li>
        <NavLink to="/addPlant" className="font-medium">
          Add Plant
        </NavLink>
      </li>
      <li>
        <NavLink to={`/myPlants/${user?.email}`} className="font-medium">
          My Plants
        </NavLink>
      </li>
      <li>
  ...
  return (
    <div className="navbar bg-secondary py-4 px-4 shadow-md">
      {/* Start */}
